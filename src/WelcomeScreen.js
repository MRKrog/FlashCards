      ...
      <section className="WelcomeScreen">
        <article className="welcome-background">
          <div className="welcome-content">
            ...
            <h2>Relaxing Memorize Flash Cards</h2>
            <p>Lets take a brief moment to relax, and once your ready, press start, to quiz yourself on HTML, CSS, &amp; Javascript Knowledge.</p>
